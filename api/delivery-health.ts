...
// Operational telemetry remains loaded through loadOperationalTelemetryEvents in delivery-health-core.ts.
export default {
  async fetch(request: Request): Promise<Response> {
    const shell = await import('../vercel/dedicated-page-shell.js');
    return shell.serveDedicatedWorkspace(request, () => import('./delivery-health-core.js'), {
