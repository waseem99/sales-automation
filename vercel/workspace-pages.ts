...
const workspaceTabs: WorkspaceTab[] = [
  ...
  { href: '/leads/tenders', text: 'Tenders', activeRoutes: ['/leads/rfq', '/leads/rfp', '/leads/eoi', '/leads/rfi', '/leads/tenders'] },
  { href: '/leads/research', text: 'Research' },
  { href: '/leads/partnerships', text: 'Partnerships' },
  { href: '/services', text: 'Services', activeRoutes: ['/services', '/services/ai', '/services/software', '/services/cybersecurity', '/services/immersive', '/services/marketing'] },
];
...
function isActiveRoute(activeRoute: string, href: string): boolean {
  ...
  if (href === '/linkedin-signals' && activeRoute === '/lead-signals') return false;
  return false;
}
