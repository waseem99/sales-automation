...
export const upworkProfiles: UpworkProfileRoute[] = [
  {
    ...
    preferredKeywords: ['rag', 'llm', 'generative ai', 'custom gpt', 'chatbot', 'machine learning', 'deep learning', 'computer vision', 'fine tuning', 'voice ai', 'langchain', 'llamaindex', 'document intelligence', 'knowledge base', 'ai automation'],
  ...
  },
  {
    ...
    avoidKeywords: ['multiplayer web game', 'full stack game', 'web game developer'],
    minimumLeadScore: 78,
    routingNotes: [
  ...
  },
  {
    ...
    avoidKeywords: ['long term animator', 'kids series', 'multiplayer arena game', 'generic game development'],
    minimumLeadScore: 82,
    routingNotes: [
