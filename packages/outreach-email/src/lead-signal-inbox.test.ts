...
import { loadLeadSignalInboxConfig, parsePotentialLeadSignalMessage } from './lead-signal-inbox.js';
...
const linkedIn = parsePotentialLeadSignalMessage({
  ...
  text: 'Looking for a software partner. https://www.linkedin.com/posts/acme_build-activity-123?trk=email',
}, config);
...
console.log('Unified lead inbox configuration and source classification tests passed');
