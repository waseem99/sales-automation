...
assert.match(operations, /Priority A\/B review queue/);
assert.match(operations, /Pilot readiness blockers/);
...
assert.match(operations, /Sales Navigator prospects/);
...
assert.match(operations, /Full commercial pilot target/);
assert.match(operations, /100, 15/);
assert.match(operations, /50, 10/);
assert.match(operations, /75, 15/);
...
assert.match(operations, /isLinkedInWarmRecord/);
assert.match(operations, /isSalesNavigatorRecord/);
assert.match(operations, /isUpworkRecord/);
assert.match(operations, /!record\.lead\.owner\?\.trim\(\)/);
assert.match(operations, /pilotReadinessGaps/);
assert.match(operations, /confirm the permitted channel/);
assert.match(operations, /attach relevant proof/);
...
assert.match(operations, /Automatic outreach must remain disabled/);
...
console.log('Owner-scoped operational metrics, pilot readiness queues, weekly outcomes, source quality, audited controls and release observability contracts passed');
